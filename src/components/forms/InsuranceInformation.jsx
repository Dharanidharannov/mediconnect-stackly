...
const InsuranceInformation = ({ initialValues, onNext, onBack }) => {
      ...
      <form onSubmit={formik.handleSubmit}>
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12 }}>
            <Box>
              <Typography variant="body2" sx={{ fontWeight: 600, mb: 1, color: '#374151' }}>
                Select insurance provider <span style={{ color: '#6b7280', fontWeight: 400 }}>(Optional)</span>
              </Typography>
              <TextField
                select
                fullWidth
          ...
          <Grid size={{ xs: 12 }}>
            <Box>
              <Typography variant="body2" sx={{ fontWeight: 600, mb: 1, color: '#374151' }}>
                Customer ID / Policy Number <span style={{ color: '#6b7280', fontWeight: 400 }}>(Optional)</span>
              </Typography>
              <TextField
                fullWidth
                name="policyNumber"
          ...
          <Grid size={{ xs: 12 }}>
            <Box>
              <Typography variant="body2" sx={{ fontWeight: 600, mb: 1, color: '#374151' }}>
                Upload Insurance Card <span style={{ color: '#6b7280', fontWeight: 400 }}>(Optional)</span>
              </Typography>
              ...
              >
                ...
                <Typography variant="caption" sx={{ color: '#6b7280', display: 'block', mt: 2, fontStyle: 'italic' }}>
                  Make sure the card is clear and all details are visible
                </Typography>
              </Paper>

              {/* Uploaded Files List - Card Style with Thumbnails */}
          ...
          <Grid size={{ xs: 12 }}>
            <FormActions
              ...
              onBack={onBack}
              nextText="Upload Health Records"
              backText="Go Back"
              disabled={false}
            />
          </Grid>
